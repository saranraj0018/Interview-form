<x-layouts.auth>
    <div class="w-full max-w-5xl bg-white rounded-3xl shadow-lg overflow-hidden flex border">
        ...
        <div class="w-full md:w-1/2 p-10 flex flex-col justify-center">
            ...
            <p class="text-sm text-black mb-6">Sign in to your HR Dashboard</p>
            ...
            <form method="POST" action="{{ route('admin.authenticate') }}" class="space-y-5" x-data="{ show: false, loading: false }"
                ...
                <div>
                    ...
                    <input type="email" name="email"
                        class="w-full border border-gray-300 rounded-md px-3 py-2 mt-1
                          focus:outline-none focus:ring-2 focus:ring-[#ea2498]"
                ...
                <div>
                    ...
                    <div class="relative">
                        <input :type="show ? 'text' : 'password'" name="password"
                            class="w-full border border-gray-300 rounded-md px-3 py-2 mt-1
                              focus:outline-none focus:ring-2 focus:ring-[#ea2498] pr-10"
                            placeholder="••••••••" />
                ...
                <button type="submit"
                    class="w-full bg-[#ea2498] text-white py-2 rounded-md flex items-center justify-center gap-2"
                    :disabled="loading">
            ...
            <p class="text-sm text-center text-gray-600 mt-6">
                ...
                <a href="{{ route('admin.register') }}" class="text-[#ea2498] font-medium hover:underline">
                    Sign Up
                </a>
            </p>
        </div>
