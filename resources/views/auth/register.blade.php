    ...
    <div class="w-full bg-white rounded-2xl max-w-2xl shadow-lg p-8 md:p-12">
        ...
        <form method="POST" action="{{ route('admin.register.update') }}" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="col-span-2">
                ...
                <select name="role"
                    class="w-full border border-gray-300 rounded-lg px-3 py-2 mt-1 focus:outline-none focus:ring-2 focus:ring-[#ea2498]">
            ...
            <div class="col-span-2">
                <button type="submit"
                    class="w-full bg-[#ea2498] text-white font-semibold py-3 rounded-lg shadow-md transition-all duration-200">
                    Sign Up
                </button>
            </div>
        </form>
        ...
        <p class="text-sm text-gray-600 text-center mt-6">
            ...
            <a href="/admin/login" class="text-[#ea2498] font-medium hover:underline">Sign In</a>
        </p>
    </div>
</x-layouts.auth>
