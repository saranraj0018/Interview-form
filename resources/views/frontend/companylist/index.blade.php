...
$companies = [
[
'name' => 'AIC Raise Business Incubator',
'positions' => 3,
'image' => 'rathinamgroup.png',
],
[
'name' => 'Gradraise Private Limited',
'positions' => 3,
'image' => 'rathinamgroup.png',
],
[
'name' => 'KPM Matriculation Higher Secondary School',
'positions' => 2,
'image' => 'rathinamgroup.png',
],
[
'name' => 'RGI @ Tips Global Campus',
'positions' => 9,
'image' => 'rathinamgroup.png',
],
[
'name' => 'Raise Smart - Edu Rathinam',
'positions' => 2,
'image' => 'rathinamgroup.png',
],
[
'name' => 'Rathinam Arumugam Research',
'positions' => 3,
'image' => 'rathinamgroup.png',
],
[
...
<div class="min-h-screen bg-[#f8fafc]">
    ...
    <div class="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3
            gap-5 lg:gap-7 pb-16">

            @foreach($companies as $company)

            <!-- CARD -->
            <a href="{{ url('/offer-list') }}" class="group relative overflow-hidden
                ...
                <div class="flex items-start justify-between mb-4">
                    ...
                    <div class="w-[72px] h-[72px]
                        ...
                        <img src="{{ asset('assets/images/' . $company['image']) }}" alt="{{ $company['name'] }}"
                    ...
                    <div class="w-10 h-10 rounded-xl
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-[#0b2c5f]
                            ...
                            transition-all duration-300" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24">
